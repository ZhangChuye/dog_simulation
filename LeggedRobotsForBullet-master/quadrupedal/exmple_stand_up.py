...
if __name__ == "__main__":
    ...
    path = "/home/ye/Project/mcr/dog_simulation/LeggedRobotsForBullet-master/quadrupedal/urdf/"
    qdrp = Quadrupedal(timeStep=1./240., initialCoMheight=0.3,startPosition=[0,0,0.55],startOrientation=[0.,0.,0.], maxForce=12,robotPATH=path+"quadrupedal.urdf")
